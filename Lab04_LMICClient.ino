...
static void tx_func(osjob_t* job) {
  ...
  // uint8_t data_array[message.length()];

  // message.getBytes(data_array, sizeof(data_array));
...
void setup() {
  ...
  uint32_t uBandwidth;
  //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  LMIC.freq = 913900000;  //change this for assigned frequencies, match with int freq in loraModem.h
  //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  uBandwidth = 125;
